...
tfidf = pickle.load(open(r"C:\Users\Lareb\Desktop\Projects\Spam Email Prediction\feature.pkl", 'rb'))
model = pickle.load(open(r"C:\Users\Lareb\Desktop\Projects\Spam Email Prediction\model.pkl", 'rb'))

st.title("Spam E-Mail Classifier")

image = Image.open(r"C:\Users\Lareb\Desktop\images.jpg")
